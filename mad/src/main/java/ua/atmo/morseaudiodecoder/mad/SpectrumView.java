...
public class SpectrumView extends View {
    ...
    private int getColor(int value, int max) {
        ...
        int idx = value/step;
        int red = interpolate(Color.red(colormap[idx]), Color.red(colormap[idx+1]), value*255/max)/255,
                green = interpolate(Color.green(colormap[idx]), Color.green(colormap[idx + 1]), value*255/max)/255,
                blue = interpolate(Color.blue(colormap[idx]), Color.blue(colormap[idx + 1]), value*255/max)/255;
        return Color.rgb(red, green, blue);
    }

    private int interpolate (int a, int b, int value) {
        return (255 - value)*a + value*b;
    }
}
